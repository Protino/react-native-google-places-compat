...
/**
 * Mapping between com.google.android.gms.location.places.Place's class id and label, to fit with iOS functionality
 */
enum class RNGooglePlacesPlaceTypeEnum(val id: Int, val label: String) {
  TYPE_OTHER(0, "other"),
  ...
  companion object {
    private val index = SparseArray<RNGooglePlacesPlaceTypeEnum>()
    ...
    fun findByTypeId(id: Int): RNGooglePlacesPlaceTypeEnum {
      return index.get(id, TYPE_OTHER)
    }
  }
}
